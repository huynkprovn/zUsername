...
namespace hi_im_gosu
{
	...
	internal class Activator
	{
		...
		public Activator()
		{
			...
			BuffList.Add(new BuffList { ChampionName = "Rammus", DisplayName = "Rammus (E)", BuffName = "PuncturingTaunt", DefaultValue = false });
			...
			BuffList.Add(new BuffList { ChampionName = "Morgana", DisplayName = "Morgana (Q)", BuffName = "DarkBindingMissile", DefaultValue = false });
